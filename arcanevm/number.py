...
class Number(object):
    def __init__(self, number: int, context: Context = None, secret_key: api_low_level.NuFHESecretKey = None):
    ...
    @staticmethod
    def decrypt(context: Context, secret_key: api_low_level.NuFHESecretKey, data: lwe.LweSampleArray) -> List[int]:
